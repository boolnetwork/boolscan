...
const Footer = () => {
  ...
  // const BLOCKSCOUT_LINKS: Array<{ icon: string; iconSize: string; text: string; url: string }> = [];
  ...
  //                       DeepDEX Explorer is a Block Explorer and Analytics Platform for the DeepDEX Finance.
  //                   </Text>
